...
👉 Read more in [Renovate documentation][renovate-docs] 👉 Use [Snyk Automated
Dependency Update PRs][snyk-prs]
...
SemVer ranges when you did not understand them fully.
...
If you are not fully aware of the implication of using SemVer ranger, you may
...
"automatically", we mean that any time you run npm install you will get the very
latest version matching your SemVer - assuming you're not using a lock file,
that is.
...
👉 [Trusted publishing is generally available][github-trusted-publishing] on
GitHub

👉 [Read more about trusted publishing][npm-trusted-publishing] on npmjs.com
...
- [Should you Pin your JavaScript dependencies?][renovate-dependecy-pinning]
- 📷 [Shantanu Kumar][photographer-shantanu-kumar] - [Wooden Door in Black and
  White][wooden-door]

## Further Reading

- [NPM Ignore Scripts Best Practices as Security Mitigation for Malicious
  Packages][npm-ignore-scripts]
- [ESLint Prettier Supply Chain Attack][eslint-prettier-supply-chain-attack]
- [Nx Supply Chain Attack][nx-supply-chain-attack]
- [Nx Packages Compromised][nx-packages-compromised]
- [Nx Postmortem][nx-postmortem]
- [Ongoing Supply Chain Attack Targets CrowdStrike NPM
  Packages][crowdsec-shai-hulud-attack]
...
[npm-ignore-scripts]:
  https://www.nodejs-security.com/blog/npm-ignore-scripts-best-practices-as-security-mitigation-for-malicious-packages
[renovate-version-pinning]: https://docs.renovatebot.com/dependency-pinning/
...
[renovate-dependecy-pinning]: https://docs.renovatebot.com/dependency-pinning/
[eslint-prettier-supply-chain-attack]: https://www.bleepingcomputer.com/news/security/popular-npm-linter-packages-hijacked-via-phishing-to-drop-malware/
[nx-supply-chain-attack]: https://snyk.io/blog/weaponizing-ai-coding-agents-for-malware-in-the-nx-malicious-package/
...
[crowdsec-shai-hulud-attack]: https://socket.dev/blog/ongoing-supply-chain-attack-targets-crowdstrike-npm-packages
