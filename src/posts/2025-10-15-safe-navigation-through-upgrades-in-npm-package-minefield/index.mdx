...
- [NPM Ignore Scripts Best Practices as Security Mitigation for Malicious Packages][npm-ignore-scripts]
...
[npm-ignore-scripts]: https://www.nodejs-security.com/blog/npm-ignore-scripts-best-practices-as-security-mitigation-for-malicious-packages
