...
For monorepo developers the trusted publishing is supported in `lerna` [from
version 9.0.0][lerna-trusted-publishing].
...
packages with minitmal or zero dependencies when possible, by leveraging modern
