...
- [Minimum Release Age: Simplest Supply Chain
  Defense][simplest-supply-chain-defense]
...
- [TanStack Postmoretem][tanstack-postmortem]
- [Socket: TanStack Compromise][socket-tanstack-compromise]
- [StepSecurity: Mini Shai-Hulud is Back][tanstack-shai-hulud-back]

## Changelog

I have been updating this post with new best practices and references as the
attacks evolve.

- 2026-05-14: Added TanStack supply chain attack references to multiple posts
  and TanStack postmortem. With the introduction of `min-release-age` for npm,
  all major package managers now support this simplest feature for supply chain
  attack mitigation. The reference to the deep dive article about Cool down
  periods was added as well.
